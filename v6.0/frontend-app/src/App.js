  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div>
          <button onClick={connectWallet} style={{ color: "yellow", background: "black", cursor: "pointer" }}>Connect Wallet</button>
        ...
        <div>
          ...
          <button onClick={deployAuctionContract} style={{ color: "yellow", background: "black", cursor: "pointer" }}>Deploy your Contract</button>
        ...
        <div>
          ...
          <div>
            <button onClick={showContractDetails} style={{ color: "yellow", background: "black", cursor: "pointer" }}>Show Details</button>
          </div>
        ...
        <div>
          ...
          <div>
            <button onClick={bidFunction} style={{ color: "yellow", background: "black", cursor: "pointer" }}>Place a Bid</button>
          </div><br />
        </div>
      </header>
    </div>
